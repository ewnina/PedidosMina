      ...
      {loading ? (
        ...
        <div className="space-y-4 mt-4">
          <div className="grid grid-cols-3 gap-3">
            <IosCard>
              <p className="text-[11px] text-[#8E8E93] text-center">Pedidos Hoy</p>
              <p className="text-[28px] font-bold text-[#007AFF] text-center">{stats.todayOrders}</p>
            </IosCard>
            <IosCard>
              <p className="text-[11px] text-[#8E8E93] text-center">Pendientes</p>
              <p className="text-[28px] font-bold text-[#FF9500] text-center">{stats.pendingOrders}</p>
            </IosCard>
            <IosCard>
              <p className="text-[11px] text-[#8E8E93] text-center">Menús</p>
          ...
          <IosCard>
            ...
            <div className="space-y-2">
              <a href="/provider/menus" className="flex items-center justify-between p-3 bg-[#F2F2F7] rounded-lg active:bg-[#E5E5EA] transition-colors">
                <span className="text-[15px]">📋 Gestionar Menús</span>
                <span className="text-[#8E8E93]">→</span>
              </a>
              <a href="/provider/orders" className="flex items-center justify-between p-3 bg-[#F2F2F7] rounded-lg active:bg-[#E5E5EA] transition-colors">
                <span className="text-[15px]">🛒 Ver Pedidos</span>
                <span className="text-[#8E8E93]">→</span>
              </a>
              <a href="/provider/whatsapp" className="flex items-center justify-between p-3 bg-[#F2F2F7] rounded-lg active:bg-[#E5E5EA] transition-colors">
                <span className="text-[15px]">💬 WhatsApp Bot</span>
                <span className="text-[#8E8E93]">→</span>
              </a>
              <a href="/provider/zones" className="flex items-center justify-between p-3 bg-[#F2F2F7] rounded-lg active:bg-[#E5E5EA] transition-colors">
